...
class RequestChangeViewController: UITableViewController, UITextFieldDelegate, UITextViewDelegate {
    ...
    @objc func send_message(){
        ...
        parameters_arr["title"] = "Appointment Request" as AnyObject
        parameters_arr["body"] = txtBody.text as AnyObject
        
        
        do{
            
            HTTP.POST(GlobalVar.URL+"request_change.php", parameters:parameters_arr) { response in
                //do things...
...
extension RequestChangeViewController: Themed {
